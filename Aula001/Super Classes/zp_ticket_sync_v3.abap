...
start-of-selection.
  ...
  case abap_true.
    ...
    when p_arti2.
       ...
       data(arti2_sys) = new zcl_ticket_ai_trg_sys(  ). "instancia da classe que herda a classe abstrata
       remote_sys = cast #( arti2_sys ).                "nova sintaxe para ligar a classe a interface
